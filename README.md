...
利用百度定位SDK为Web app解决Android在大陆定位不准的问题。iOS下并无定位不准问题，可直接使用浏览器定位。更新自[hewz](https://github.com/hewz/cordova-baidu-location)
...
### 二，安装插件
cordova plugin add https://github.com/zijiu/location --variable API_KEY="your key"
...
### 删除插件
```
cordova plugin rm zijiu.plugins.baidu-location
```
